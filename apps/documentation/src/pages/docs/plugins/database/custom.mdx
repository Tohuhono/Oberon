...
A database adater must implement the following interface:
...
```
Additionally, if you are using the recommended Auth.js implemenation you should implement the following. See [Auth.js adapters](https://authjs.dev/reference/core/adapters) for more details.
