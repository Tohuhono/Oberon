...
OberonCMS applications are built on Next.js and can be deployed to any platform that supports
Node.js 22+. Here's how to deploy your OberonCMS app to popular platforms.
...
<Callout type="warning">
  **Database connection errors?** Check that database credentials are correct and the database is
