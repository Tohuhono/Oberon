...
Use a custom plugin when the built-in providers do not match your runtime, storage, delivery, or
...
[Handler Hooks](/docs/plugins/custom/handler-hooks) depending on what your plugin needs to add.
