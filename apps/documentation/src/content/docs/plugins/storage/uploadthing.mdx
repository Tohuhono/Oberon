...
A plugin that provides image storage and upload functionality for OberonCMS using
...
First, create an [Uploadthing](https://uploadthing.com/) account and get your API keys.
...
<Callout type="info">
  The Uploadthing plugin ships the file router and route handler internally. You only need to
  include the plugin and wire your Oberon API route.
</Callout>

## Image deletion

The Uploadthing plugin automatically handles image deletion. When you delete an image in the CMS,
it:
