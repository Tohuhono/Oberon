...
OberonCMS uses Puck's component model. Puck components are defined in the runtime config at
`oberon/config.tsx` and rendered by the visual editor.
...
Then register it in your runtime config:
