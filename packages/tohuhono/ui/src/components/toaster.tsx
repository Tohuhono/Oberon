...
const toastVariants = cva(
  `
    group pointer-events-auto relative w-full overflow-hidden rounded-md border
    p-4 pr-6 shadow-lg transition-all
    data-ending-style:animate-out data-ending-style:fade-out-80
    data-ending-style:slide-out-to-top-full
    data-starting-style:animate-in data-starting-style:slide-in-from-top-full
