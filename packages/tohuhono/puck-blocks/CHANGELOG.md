...
- 6e8ba23: Replace deprecated Puck DropZone usage in shared Container and Prose blocks with slot
  fields.
...
- a73560b: Patch Vitest tag filtering so dynamic issue tags skip cleanly instead of failing
  repo-wide test runs.
- 28aa7e5: Add transform metadata to the example Text component configuration so migration state can
