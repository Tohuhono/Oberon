...
export const CardsCookieSettings = dynamic(
  () => import("../components/cards/cookie-settings").then((m) => m.CardsCookieSettings),
  { ssr: false },
)
export const CardsCreateAccount = dynamic(
  () => import("../components/cards/create-account").then((m) => m.CardsCreateAccount),
  { ssr: false },
)
...
export const CardsPaymentMethod = dynamic(
  () => import("../components/cards/payment-method").then((m) => m.CardsPaymentMethod),
  { ssr: false },
)
