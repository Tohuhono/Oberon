...
import { UserSchema, JsonValueSchema, type OberonDatabaseAdapter } from "@oberoncms/core"
...
export const getDatabaseAdapter: (db: () => DatabaseClient) => OberonDatabaseAdapter = (db) => ({
  getSite: async () => {
